...
DECLARE_TRACEPOINT(allochugepmdpage);
void do_trace_allochugepmdpage(unsigned long cycles);

DECLARE_TRACEPOINT(zerohugepmdpage);
			...
			struct page *page, gfp_t gfp)
{
	...
	__folio_mark_uptodate(folio);
        ...
        if (tracepoint_enabled(zerohugepmdpage)) {
                do_trace_zerohugepmdpage(get_cycles() - cycles);
        }
#endif /* CONFIG_PFTRACE */
...
#ifdef CONFIG_PFTRACE
        if (tracepoint_enabled(allochugepmdpage)) {
                do_trace_allochugepmdpage(get_cycles() - cycles);
        }               
#endif /* CONFIG_PFTRACE */
