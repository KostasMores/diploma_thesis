...
BPF_CALL_2(bpf_update_orders, struct mm_action *, action, unsigned long, bpf_orders) {
	action->hugepage_orders = bpf_orders;
	return 0;
}

const struct bpf_func_proto bpf_update_orders_proto = {
	.func		= bpf_update_orders,
	.gpl_only	= false,
	.ret_type	= RET_VOID,
	.arg1_type	= ARG_ANYTHING,
	.arg2_type	= ARG_ANYTHING,
...
bpf_base_func_proto(enum bpf_func_id func_id, const struct bpf_prog *prog)
{
	...
	case BPF_FUNC_update_orders:
		return &bpf_update_orders_proto;
	default:
		break;
	}
