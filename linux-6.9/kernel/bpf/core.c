...
const struct bpf_func_proto bpf_update_action_proto __weak;
const struct bpf_func_proto bpf_update_orders_proto __weak;
const struct bpf_func_proto bpf_free_huge_page_status_proto __weak;
